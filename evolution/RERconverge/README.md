...
Usage
python get_protein.py --input-feature-txt GCF_000003025.6_Sscrofa11.1_feature_table.txt --species pig --input-protein-faa GCF_000003025.6_Sscrofa11.1_protein.faa
```
