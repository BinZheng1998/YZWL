...
violin_data <- df@meta.data[, c("orig.ident", "nFeature_RNA")]
p<-ggplot(violin_data, aes(x = orig.ident, y = nFeature_RNA,fill=orig.ident)) +
...
output_file <- paste0(sample_name, "_sample_gene_number.png")
