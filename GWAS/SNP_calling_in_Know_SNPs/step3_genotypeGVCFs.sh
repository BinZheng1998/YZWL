...
golden_snp="/share/org/YZWL/yzwl_zhengbin/project/01-gwas/01-result/vcf/dbsnp/chicken_site_snp.vcf"
for chr in {1..38} Z W MT; do 
    ...
    echo '#CSUB -n 16' >> "$chr_script"  # 使用16个线程
    ...
    echo 'gatk --java-options "-Xmx160g" GenotypeGVCFs \' >> "$chr_script"
    echo '--force-output-intervals '${golden_snp}' \' >> "$chr_script" 
