...
# 设置序列数据文件数组
species=("mexican_gray_wolf" "bighorn_sheep" "banteng" "common_warthog" "rock_ptarmigan" "pig" "dog" "sheep" "cattle" "chicken")
# 输入的人类蛋白 ID 文件路径
human_id_file="/home/bzheng/project/01_evolution/convergent_evolution/07_result/20251016_5spcies_analysis/1.protein_data/human_info.txt"

# 结果目录
result_dir="/home/bzheng/project/01_evolution/convergent_evolution/07_result/20251016_5spcies_analysis/2.RBBH"
