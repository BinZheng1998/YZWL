...
txt_file = "/home/bzheng/project/01_evolution/convergent_evolution/07_result/20251016_5spcies_analysis/2.RBBH/rbh_combined.txt"
...
def process_batch(batch_rows, batch_num):
    ...
    with Pool(processes=20) as pool:  # 调整为服务器核心数/66，例如256核心用4
