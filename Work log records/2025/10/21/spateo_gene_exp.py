...
def add_exp_label(adata, embryo_pc, marker):
    ...
    low_color = np.array([0.5, 0.5, 0.5])   # 背景：浅灰色RGB
...
def add_celltype_label(adata, embryo_pc, target_celltype):
    ...
    rgba[is_target] = [0.0, 1.0, 0.0, 1.0]
...
lung_cell = pd.read_table('/home/bzheng/project/03_3D_spatial/04_cell_annotation/new_data_2509/lung/E45_lung.txt')
...
color_list = ["#E5E5E5","#E5E5E5"] ##E5E5E5 为grey90"#0000FF"
...
plot_3d_pc(sub_ad, embryo_pc, mesh_model, 'marker','ANXA8L1', '/home/bzheng/project/03_3D_spatial/02_result/202510-res/E45_ANXA8L1.html')
