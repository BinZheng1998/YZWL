...
library(dplyr)
chicken <- read.table("../chicken/chicken_BW_pos_DCMS_top_001_merged_regions_50kb_genes.txt",sep = '\t',header = T)
...
cattle <- read.table("../cattle/cattle_BW_pos_DCMS_top_001_merged_regions_50kb_genes.txt",sep = '\t',header = T)
...
pig <- read.table("../pig/pig_BW_pos_DCMS_top_001_merged_regions_50kb_genes.txt",sep = '\t',header = T)
...
sheep <- read.table("../sheep/sheep_BW_pos_DCMS_top_001_merged_regions_50kb_genes.txt",sep = '\t',header = T)
...
dog <- read.table("../dog/dog_BW_pos_DCMS_top_001_merged_regions_50kb_genes.txt",sep = '\t',header = T)
...
write.table(filtered_data,file = "5species_pos_BW_top1_50kb_homo_genes.txt",sep = '\t',row.names = F)
...
write.table(filtered_data,file = "4species_pos_BW_top1_50kb_homo_genes.txt",sep = '\t',row.names = F)
