...
txt_file = "/home/bzheng/project/11_multic_species_homologs/RBBH_res/rbh_combined_31species.txt"  # 你的TXT文件
output_dir = "/home/bzheng/project/01_evolution/convergent_evolution/07_result/20250827_RER/mafft_0905"  # 输出目录
...
for index, row in df.iterrows():
    ...
    try:
        ...
        with open(temp_aligned_file, "w") as out:
            subprocess.run(["mafft", "--auto", "--thread", "48", sub_fasta_file], stdout=out, check=True)
