...
library(patchwork)
library(aplot)
data1 <- readRDS('../E4.5_foregut.rds')
data1@meta.data$celltype_gut <- recode(data1@meta.data$celltype_gut,
                                       "Foregut Mesothelial cells" = "Foregut Mesothelial Cells",
                                       "Spleno-Pancreatic Mesenchyme Progenitor Cells" = "Spleno-Pancreatic Mesenchymal Progenitor Cells")
...
marker_genes <-c('SST1','LHX2','LRRN4','ASIP','NKX2-1','RIPPLY3','SYT10','MLLT3','ADCY8','TBX4','CCDC80','GATA4',
                 'WNT11','SULF1','WNT2B','SMOC2','CYP2C23a','AGR2','PLAC9','CDH12',
                 'BARX1','NKX3-2','GKN2','NKX6-2','BMP4','NKX2-3',
                 'RSPO1','LMO3','FGG','FGA','OTOP1','SOX17',
                 'ADAMTS18','CYTL1','AQP5','TM4SF4','UTS2B','SLC51B','CD9','LIMCH1','INS','GCG',
                 'ANO1','MAB21L1','CA8','HOXA10','SATB2','GUCA2B','HOXD13','EVX1','TLX1','FGF14')
...
table(data1$celltype_gut)
celltype <- c('Foregut Mesothelial Cells','Gut Mesothelial Cells','Lung Primary Bronchi','Lung Secondary Bronchi',
              'Lung Progenitor Cells','Lung Mesenchymal Progenitor Cells','Trachea Mesenchymal Progenitor Cells',
              'Proventriculus Progenitor Cells','Proventriculus Mucosa Epithelial Cells','Proventriculus Mesothelial Cells',
              'Gizzard Progenitor Cells','Gizzard Mucosa Epithelial Cells',
              'Gizzard-Duodenum Mesenchymal Progenitor Cells','Gizzard Mesenchymal Progenitor Cells',
              'Hepatocyte Progenitor Cells','Hepatopancreatic Ductal Progenitor Cells','Duodenum Progenitor Cells',
              'Duodenum Mucosa Epithelial Cells','Duodenum Enterocyte-Neurons Cells',
              ...
              'Spleno-Pancreatic Mesenchymal Progenitor Cells'
)
...
p_combined <- p_main %>% insert_left(p_dots,width = 0.01)
#p_combined <-  p_dots %>% insert_left(p_main,width = 0.99)
p_combined
ggsave('E4.5_cellmarker_violin.pdf',p_combined,width = 22,height = 10,dpi = 300)
...
pdf('E4.5_treemap.pdf',width = 8,height = 6)
drawTreemap(
  tm,
  color_type = "categorical",
  color_level = 2,
  color_palette = df$my_colors,
  legend = F,
  label_autoscale=F,
  label_size = 3,
  label_level = 1:2,
