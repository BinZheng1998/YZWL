...
library(patchwork)
library(aplot)
data1 <- readRDS('../E3.5_foregut.rds')
...
marker_genes <-c('TNC','LHX2','NKX2-1','RIPPLY3','ADCY8','MLLT3','ZFPM2','APCDD1L',
                 'WNT2B','SMOC2','CYP2C23a','AGR2','BARX1','NKX3-2','GKN2','NKX6-2',
                 'GPC3','CCDC85A','FGG','FGA','PODXL','NKX2-3','AQP5','TM4SF4',
...
p_combined
ggsave('E3.5_cellmarker_violin.pdf',p_combined,width = 22,height = 8,dpi = 300)
...
pdf('E3.5_treemap.pdf',width = 8,height = 6)
drawTreemap(
  tm,
