...
data@meta.data$celltype_gut <- recode(
  ...
  "0" = "Gizzard Stem Cells",
  "12" = "Gizzard Stem Cells",
  "16" = "Gizzard Stem Cells",
  "24" = "Gizzard Stem Cells",
  "3" = "Proventriculus Stem Cells",
  "5" = "Proventriculus Stem Cells",
  "14" = "Proventriculus Stem Cells",
  "26" = "Proventriculus Stem Cells",
  "6" = "Lung Bud",
  "7" = "Lung Bud",
  "1" = "Duodenum-Midgut Stem Cells",
  "4" = "Foregut Stem Cells1",
  "18" = "Foregut Stem Cells1",
  "11" = "Foregut Stem Cells2",
  "25" = "Foregut Stem Cells3",
  "9" = "Foregut Stem Cells4",
  "22" = "Foregut Stem Cells5",
  "23" = "Foregut Stem Cells6",
  "19" = "Pancreatic Bud",
  "27" = "Duodenum Mucosa Epithelium",
  "21" = "Duodenum Endocrine Cells"
)
head(data@meta.data,n=50)

data1 <- subset(data,subset = celltype_gut %in% c("Gizzard Stem Cells",
                                          "Proventriculus Stem Cells",
                                          "Lung Bud",
                                          "Duodenum-Midgut Stem Cells",
                                          "Foregut Stem Cells1","Foregut Stem Cells2",
                                          "Foregut Stem Cells3","Foregut Stem Cells4",
                                          "Foregut Stem Cells5","Foregut Stem Cells6",
                                          "Pancreatic Bud",
                                          "Duodenum Mucosa Epithelium",
